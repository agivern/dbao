...
class ContenuRealisation
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="DBAO\BDDBundle\Entity\Realisation")
     ...
     * @return ContenuRealisation
     */
    public function setRealisation(\DBAO\BDDBundle\Entity\Realisation $realisation)
    {
